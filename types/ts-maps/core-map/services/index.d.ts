...
import type { DirectionsProvider, GeocoderProvider, IsochroneProvider, MatrixProvider } from './types';
export declare const defaultGeocoder: () => GeocoderProvider;
export declare const defaultDirections: () => DirectionsProvider;
export declare const defaultIsochrone: () => IsochroneProvider;
...
export declare const defaultMatrix: () => MatrixProvider;
export declare const valhallaMatrix: () => MatrixProvider;
...
export declare const valhallaDirections: () => DirectionsProvider;
